...
class _HomeState extends State<Home> {
 ...
 Uri.parse('ws://instagram.ns0.it:62181'));
...
Future<String?> _getId() async {
          ...
          builder: (context, snapshot) {
            if(snapshot.hasData){
              ...
              if(data['cmd']=="player_list"){
                print("LIST OF PLAYERS:"+data['player_list'].toString()); // is a array
              }
            } catch(e){
  ...
  void _join() {
    ...
    if (_username.text.isNotEmpty) {
      ...
      _channel.sink.add(JsonEncoder().convert(obj)); // convert into a JSON STRING 
    }
  }
  @override
  void dispose(){
